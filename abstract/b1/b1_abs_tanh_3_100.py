...
if relu:
    pt_file0 = os.path.join(script_path, "b1_relu_abs-actor" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file1 = os.path.join(script_path, "b1_relu_abs-critic" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file2 = os.path.join(script_path, "b1_relu_abs-actor-target" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file3 = os.path.join(script_path,
                            "b1_relu_abs-critic-target" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
else:
    pt_file0 = os.path.join(script_path, "b1_abs-actor" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file1 = os.path.join(script_path, "b1_abs-critic" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file2 = os.path.join(script_path, "b1_abs-actor-target" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file3 = os.path.join(script_path, "b1_abs-critic-target" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
...
def train_model(agent):
    ...
    for j in range(20):
        ...
        for episode in range(300):
            ...
            if episode >= 50 and np.min(reward_list[-5:]) >= -125:
